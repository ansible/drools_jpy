...
def make_instance():
    ...
    if jar_file_path is None:
        ...
        jar_file_path = os.path.join(
            package_dir,
            "jars/drools-yaml-rules-durable-rest-1.0.0-SNAPSHOT-runner.jar",
        )
    ...
    from drools.jpy_durable_rules_engine import JpyDurableRulesEngine

    return JpyDurableRulesEngine(jar_file_path)
